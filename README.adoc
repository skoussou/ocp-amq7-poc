...
* * [underline]#Activity 3:# Create Secret based on certs and asign to SA (MAY HAVE TO DO AFTER INSTALLATION OF OBJETS so SA exists)
...
* * [underline]#Activity 4:# Install ScaleDown controller in namespace *amq-pocs*
